...
// Colori base per ciascun tasto
#define CAPS_RED 255    // Rosso puro per CapsLock
#define CAPS_GREEN 0
#define CAPS_BLUE 0

#define NUM_RED 0       // Blu puro per NumLock (invertito)
#define NUM_GREEN 0
#define NUM_BLUE 255

#define SCROLL_RED 0    // Verde puro per ScrollLock
